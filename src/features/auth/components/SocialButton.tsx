...
export const SocialButton: React.FC<SocialButtonProps> = ({
  ...
  return (
    <button
      ...
      className="w-full row-center-flex gap-x-3 border border-zinc-600 mx-auto font-poppins font-bold cursor-pointer rounded-3xl bg-white text-black px-3 py-3 hover:bg-zinc-100 transition-colors duration-200"
    >
      {icon && icon}
      {text}
    </button>
